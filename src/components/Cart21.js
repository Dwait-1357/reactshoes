...
const Cart = () => 
{    
    const { cart, clearCart, total_price, shipping_fee,setCart } = useCartContext();
    ...
    return (
        <div className="cart-container">
            ...
            <div className="action-buttons">
                {/* <NavLink to="/product">
                    <button className="continue-shopping-btn" onClick={placeOrder}>Continue Shopping</button>
                </NavLink> */}
                <button className="clear-cart-btn" onClick={clearCart}>Clear Cart</button>
                <button className="continue-shopping-btn">Place Order</button>
                <button className="continue-shopping-btn" onClick={placeOrder}>Save Cart</button>

                {/* <button className="continue-shopping-btn" onClick={placeOrder}>PayNow</button> */}
